...
/**
 * Created by Mojtaba Rajabi on 15/04/2018.
 */
...
public class MyCardview extends CardView {
    ...
    public interface OnInterceptTouchEventListener {
         ...
         */
        boolean onInterceptTouchEvent(MyCardview view, MotionEvent ev, boolean disallowIntercept);

        /**
         * @see android.view.View#onTouchEvent(android.view.MotionEvent)
         */
        boolean onTouchEvent(MyCardview view, MotionEvent event);
    }
...
//    public MyCardview(Context context, AttributeSet attrs, int defStyleAttr, int defStyle) {
